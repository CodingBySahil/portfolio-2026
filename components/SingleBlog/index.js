    ...
    return (
        <div className={styles.blogContainer}>
            ...
            <div className={styles.leftArea}>
                <Image src={portfolio1} alt="SmartConnect AI dashboard" width={350}/>
            </div>
            <div className={styles.rightArea}>
                <h3>SmartConnect AI — Professional networking reimagined</h3>
                <p>Designed a modern dashboard with AI recommendations, real-time messaging, and intuitive networking features.</p>
        </div>
        </div>
        {/* <!-- <ul class="meta-area">
